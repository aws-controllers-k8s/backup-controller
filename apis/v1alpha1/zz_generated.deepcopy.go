...
func (in *RuleInput) DeepCopyInto(out *RuleInput) {
	*out = *in
	...
	if in.TargetLogicallyAirGappedBackupVaultRef != nil {
		in, out := &in.TargetLogicallyAirGappedBackupVaultRef, &out.TargetLogicallyAirGappedBackupVaultRef
		*out = new(corev1alpha1.AWSResourceReferenceWrapper)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ScanSetting) DeepCopyInto(out *ScanSetting) {
	*out = *in
	...
	if in.ScannerRoleRef != nil {
		in, out := &in.ScannerRoleRef, &out.ScannerRoleRef
		*out = new(corev1alpha1.AWSResourceReferenceWrapper)
		(*in).DeepCopyInto(*out)
	}
}
