...
// +kubebuilder:rbac:groups=backup.services.k8s.aws,resources=backupplans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.services.k8s.aws,resources=backupplans/status,verbs=get;update;patch
...
func (rm *resourceManager) FilterSystemTags(res acktypes.AWSResource, systemTags []string) {
	...
	r.ko.Spec.BackupPlanTags = fromACKTags(resourceTags, tagKeyOrder)
}
...
func mirrorAWSTags(a *resource, b *resource) {
	...
	existingDesiredTags = a.ko.Spec.BackupPlanTags
	existingLatestTags = b.ko.Spec.BackupPlanTags
	...
	a.ko.Spec.BackupPlanTags = fromACKTags(desiredTags, desiredTagKeyOrder)
}
