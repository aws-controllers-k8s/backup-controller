...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.BackupVaultName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["backupVaultName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: backupVaultName"))
	}
	r.ko.Spec.BackupVaultName = &primaryKey
