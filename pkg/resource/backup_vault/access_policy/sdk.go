...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "PutBackupVaultAccessPolicy", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.DeleteBackupVaultAccessPolicyOutput
	_ = resp
	resp, err = rm.sdkapi.DeleteBackupVaultAccessPolicy(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeleteBackupVaultAccessPolicy", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteBackupVaultAccessPolicyInput, error) {
	res := &svcsdk.DeleteBackupVaultAccessPolicyInput{}
