...
func (rm *resourceManager) FilterSystemTags(res acktypes.AWSResource, systemTags []string) {
	...
	r.ko.Spec.BackupVaultTags = fromACKTags(resourceTags, tagKeyOrder)
}
...
func mirrorAWSTags(a *resource, b *resource) {
	...
	existingDesiredTags = a.ko.Spec.BackupVaultTags
	existingLatestTags = b.ko.Spec.BackupVaultTags
	...
	a.ko.Spec.BackupVaultTags = fromACKTags(desiredTags, desiredTagKeyOrder)
}
