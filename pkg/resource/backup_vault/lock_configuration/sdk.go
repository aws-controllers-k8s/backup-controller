...
var (
	...
	_ = strings.ToLower("")
	_ = &svcsdk.Client{}
	_ = &svcapitypes.LockConfiguration{}
...
func (rm *resourceManager) sdkFind(
	...
	return rm.customFindLockConfiguration(ctx, r)
}
...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "PutBackupVaultLockConfiguration", err)
	if err != nil {
		return nil, err
	}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.DeleteBackupVaultLockConfigurationOutput
	_ = resp
	resp, err = rm.sdkapi.DeleteBackupVaultLockConfiguration(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeleteBackupVaultLockConfiguration", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteBackupVaultLockConfigurationInput, error) {
	res := &svcsdk.DeleteBackupVaultLockConfigurationInput{}
