...
func (rm *resourceManager) sdkFind(
	...
	if err != nil {
		...
		if errors.As(err, &awsErr) {
			...
			case "UNKNOWN", "ResourceNotFoundException", "AccessDeniedException":
				// NOTE: The AWS Backup DescribeBackupVault API returns
				// AccessDeniedException when the vault does not exist, rather
				// than ResourceNotFoundException. We treat this as NotFound so
				// the controller proceeds to create the resource.
				return nil, ackerr.NotFound
			}
		}
		return nil, err
...
func (rm *resourceManager) requiredFieldsMissingFromReadOneInput(
	...
	return r.ko.Spec.BackupVaultName == nil
...
func (rm *resourceManager) newDescribeRequestPayload(
	...
	if r.ko.Spec.BackupVaultName != nil {
		res.BackupVaultName = r.ko.Spec.BackupVaultName
	}
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.BackupVaultTags != nil {
		res.BackupVaultTags = aws.ToStringMap(r.ko.Spec.BackupVaultTags)
	}
