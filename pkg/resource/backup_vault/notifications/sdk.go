...
func (rm *resourceManager) sdkFind(
	...
	if resp.SNSTopicArn != nil {
		ko.Spec.SNSTopicARN = resp.SNSTopicArn
	} else {
...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "PutBackupVaultNotifications", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.Events != nil {
		f0 := []svcsdktypes.BackupVaultEvent{}
		for _, f0iter := range r.ko.Spec.Events {
			var f0elem string
			f0elem = string(*f0iter)
			f0 = append(f0, svcsdktypes.BackupVaultEvent(f0elem))
		}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.DeleteBackupVaultNotificationsOutput
	_ = resp
	resp, err = rm.sdkapi.DeleteBackupVaultNotifications(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "DeleteBackupVaultNotifications", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteBackupVaultNotificationsInput, error) {
	res := &svcsdk.DeleteBackupVaultNotificationsInput{}
