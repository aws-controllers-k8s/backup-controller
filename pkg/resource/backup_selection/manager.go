...
// +kubebuilder:rbac:groups=backup.services.k8s.aws,resources=backupselections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.services.k8s.aws,resources=backupselections/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"Conditions"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.Conditions != nil && latestKo.Spec.Conditions == nil {
		latestKo.Spec.Conditions = observedKo.Spec.Conditions
	}
